...
public class MainActivity extends AppCompatActivity {
    ...
    void loadWeatherData() {
        URL forecastURL = NetworkUtils.buildUrl(SunshinePreferences.getPreferredWeatherLocation(this));
        new ForecastAsyncTask().execute(forecastURL);
    }
    ...
    public class ForecastAsyncTask extends AsyncTask<URL, Void, String[]> {

        @Override
        protected String[] doInBackground(URL... urls) {
            URL forecastURL = urls[0];
            try {
                String forecastJson = NetworkUtils.getResponseFromHttpUrl(forecastURL);
                String[] simpleJsonWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, forecastJson);
